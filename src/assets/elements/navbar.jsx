    ...
    >
      ...
      <AnimatePresence>
        {isOpen && (
          ...
          >
            <NavItems href="#hero" onClick={toggleNavbar}>Home</NavItems>
            <NavItems href="#about" onClick={toggleNavbar}>About</NavItems>
            <NavItems href="#services" onClick={toggleNavbar}>Services</NavItems>
            <NavItems href="#contact" onClick={toggleNavbar}>Contact</NavItems>
          </motion.ul>
        )}
      </AnimatePresence>
    </div>
