...
const Footer = () => {
  return(
    <div id="footer" className="flex flex-col justify-center pt-50 md:pt-100 md:px-60 font-montserrat text-white min-h-screen">
        ...
        <div className="flex flex-row justify-between w-full px-5 mt-40 md:mt-70 md:pt-180 md:mb-15">
