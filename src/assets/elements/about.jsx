...
const About = () => {
    return (
      <div id="about" className="flex flex-wrap flex-row justify-between px-11 pt-20 my-20 md:px-60 z-10 md:py-40 text-white font-montserrat">
        <div className="flex flex-col md:flex md:flex-col md:py-0 ">
          <SlideScroll className={"text-2xl md:text-6xl font-bold"} direction="x" outputRange={[-100,0]}>About Me</SlideScroll>
          <SlideScroll className={"border border-white w-[50px] md:w-[120px] h-[2px] mt-2 md:mt-5 mb-2 md:mb-5"} outputRange={[-100,0]}></SlideScroll>
          <FadeScroll><img src={pic2} className="md:w-[450px] w-full self-center grayscale mt-10 hover:grayscale-0 ease-in-out duration-300 " /></FadeScroll>
        </div>
