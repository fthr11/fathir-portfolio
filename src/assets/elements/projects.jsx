            ...
            <div className="min-w-full gap-4 md:gap-0">
                <FadeScroll >
                    <div className="flex flex-row w-full">
                        <img className="h-[132px] md:h-[430px]" src="media/logo1.png"/>
                        <img className="h-[132px] md:h-[430px]" src="media/logo2.png"/>
                        <img className="h-[132px] md:h-[430px]" src="media/logo3.png"/>
                        
                    </div>
                    <img src="media/design2.png"/>

                    <div className="flex flex-row w-full">
                        <img className="h-[124px] md:h-[410px]" src="media/design3.png"/>
                        <img className="h-[124px] md:h-[410px]" src="media/design1.png"/>
                        <img className="h-[124px] md:h-[410px]" src="media/design4.png"/>  
                    </div>
                    
                    <img src="media/design2.1.png" alt="" />

                    <div className="flex flex-row w-full">
                        <img className="h-[144px] md:h-[480px]" src="media/design2.2.png"/>
                        <img className="h-[144px] md:h-[480px]" src="media/design2.3.png"/>
                    </div>
                </FadeScroll>
            </div>
        </div>
