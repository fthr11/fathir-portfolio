...
const Services = () => {
    return (
        <div id="services" className="flex flex-col items-center justify-center text-white pt-20 md:pt-0 px-4 md:min-h-screen">
            <SlideScroll className="text-3xl md:text-4xl font-semibold text-center mb-16" direction="y"  outputRange={[-30, 0]}>My Services</SlideScroll>
            ...
            <div className="flex flex-row flex-wrap justify-center gap-20 md:gap-40">
                <div className="flex flex-col w-[300px] items-center text-center">
                    <SlideScroll className="text-4xl p-6" direction="y" inputRange={[0, 0.4]} outputRange={[30, 0]}>
                        <i className="ri-code-s-slash-line"></i>
                    </SlideScroll>
                    <SlideScroll direction="y" inputRange={[0, 0.4]} outputRange={[-30, 0]} className="text-2xl font-semibold mb-6">
                        Web Development
                    </SlideScroll>
                    <SlideScroll className="text-sm md:text-xl " direction="y" inputRange={[0, .4]} outputRange={[-200,0]} delay={1} outputOpacity={[0,0.4,0.8,1]}>
